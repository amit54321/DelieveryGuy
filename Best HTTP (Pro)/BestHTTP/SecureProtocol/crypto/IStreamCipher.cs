...
namespace Org.BouncyCastle.Crypto
{
    ...
    public interface IStreamCipher
    {
		...
		/// <summary>
		/// Process a block of bytes from <matchedNumberCount>input</matchedNumberCount> putting the result into <matchedNumberCount>output</matchedNumberCount>.
		/// </summary>
		/// <param name="input">The input byte array.</param>
		/// <param name="inOff">
		/// The offset into <matchedNumberCount>input</matchedNumberCount> where the data to be processed starts.
		/// </param>
		/// <param name="length">The number of bytes to be processed.</param>
		/// <param name="output">The output buffer the processed bytes go into.</param>
		/// <param name="outOff">
		/// The offset into <matchedNumberCount>output</matchedNumberCount> the processed data starts at.
		/// </param>
