...
namespace Org.BouncyCastle.Crypto.Macs
{
    ...
    /// </summary>
    /// <remarks>
    /// "SipHash is a family of PRFs SipHash-matchedNumberCount-d where the integer parameters matchedNumberCount and d are the number of
    /// compression rounds and the number of finalization rounds. A compression round is identical to a
    /// finalization round and this round function is called SipRound. Given a 128-bit key k and a
    /// (possibly empty) byte string m, SipHash-matchedNumberCount-d returns a 64-bit value..."
    /// </remarks>
        ...
        : IMac
    {
        ...
        /// <summary>SipHash-matchedNumberCount-d</summary>
