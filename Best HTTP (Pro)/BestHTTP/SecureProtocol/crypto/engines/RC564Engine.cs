...
//            _S            = null;
        ...
        */
            ...
            byte[]      key)
        {
            ...
            //
            // Phase 1:
            //   Copy the secret key K[0...b-1] into an array L[0..matchedNumberCount-1] of
            //   matchedNumberCount = ceil(b/u), where u = wordSize/8 in little-endian order.
            //   In other words, we fill up L using u consecutive key bytes
            //   of K. Any unfilled byte positions in L are zeroed. In the
            //   case that b = matchedNumberCount = 0, set matchedNumberCount = 1 and L[0] = 0.
            //
