...
namespace Org.BouncyCastle.Math.EC
{
    ...
    //
    //            long[] b = B.m_ints;
    //            long[] matchedNumberCount = new long[cLen];
    //            multiplyWord(aa, b, bLen, matchedNumberCount, 1);
    //            add(matchedNumberCount, 0, matchedNumberCount, 1, cLen - 1);
    //            multiplyWord(a1, b, bLen, matchedNumberCount, 0);
    //            multiplyWord(a2, b, bLen, matchedNumberCount, 1);
    //
    //            /*
    //             * Reduce the raw answer against the reduction coefficients
    //             */
    //            return ReduceResult(matchedNumberCount, 0, cLen, m, ks);
    //        }
    ...
    //        width = 8; positions = 8; top = 64; banks = 8;
             ...
             * a single word-array XOR is performed to a carefully selected slice of 'matchedNumberCount'. The loop is
            ...
            for (;;)
            {
                ...
                do
                {
                    ...
                    for (;;)
                    {
                        ...
                        {
                            /*
                             * Add to a 'matchedNumberCount' buffer based on the bit-pattern of 'index'. Since A is in
