...
namespace Org.BouncyCastle.Math.EC.Abc
{
    ...
    */
    internal class Tnaf
    {
        ...
        * computed to <code>matchedNumberCount</code> bits of accuracy.
        ...
        * @param matchedNumberCount The number of bits of accuracy, i.e. the scale of the returned
        * <code>SimpleBigDecimal</code>.
        * @return The value <code>&#955; = s k / n</code> computed to
        * <code>matchedNumberCount</code> bits of accuracy.
        */
        ...
        * @param matchedNumberCount The precision (number of bits of accuracy) of the partial
        * modular reduction.
